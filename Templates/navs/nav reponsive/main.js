...
const showNav = (e) => {
    ...
    e.target.classList.contains('clicked') ? (nav.style.cssText = 'display: flex;', setTimeout(() => nav.style.transform = 'translateY(0)', 300)) : (nav.style.transform = 'translateY(-100%)', setTimeout(() => nav.style.display = 'none', 700));
}
//events 
